...
class SectionConfigSlim(BaseModel):
    ...
    rel_strength: tuple[Optional[bool], Optional[str]] = Field(default=(None, None), description="rel_strengthFlg:bool?-isCol|rel_strengthVal:str?-val")
    method: tuple[Optional[bool], Optional[str]] = Field(default=(None, None), description="methodFlg:bool?-isCol|methodVal:str?-val")
